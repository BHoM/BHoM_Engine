...
namespace BH.Engine.Physical
{
    public static partial class Query
    {
        ...
        public static List<Polyline> InternalPolyline(BH.oM.Physical.Elements.ISurface physicalObject)
        {
            ...
            {
                BH.Engine.Base.Compute.RecordError("Cannot query the internal polyline of a null surface.");
        ...
        public static List<Polyline> InternalPolyline(IOpening physicalOpening)
        {
            ...
            {
                BH.Engine.Base.Compute.RecordError("Cannot query the internal polyline of a null opening.");
                return new List<Polyline>();
            }
