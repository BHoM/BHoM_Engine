...
namespace BH.Engine.Physical
{
    public static partial class Create
    {
        ...
        public static ShapeCode25 ShapeCode25(double a, double b, double c, double d, double e, double diameter, double bendRadius)
        {
            ...
            ShapeCode25 shapeCode = new ShapeCode25(a, b, c, d, e, diameter, bendRadius);
