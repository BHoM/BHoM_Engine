...
namespace BH.Engine.Physical
{
    public static partial class Create
    {
        ...
        public static ShapeCode33 ShapeCode33(double a, double b,double c, double diameter, double bendRadius)
        {
            ...
            ShapeCode33 shapeCode = new ShapeCode33(a, b, c, diameter, bendRadius);
