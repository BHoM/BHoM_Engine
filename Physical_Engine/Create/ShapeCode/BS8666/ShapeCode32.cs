...
namespace BH.Engine.Physical
{
    public static partial class Create
    {
        ...
        public static ShapeCode32 ShapeCode32(double a, double b,double c, double d, double diameter, double bendRadius)
        {
            ...
            ShapeCode32 shapeCode = new ShapeCode32(a, b, c, d, diameter, bendRadius);
