...
namespace BH.Engine.Physical
{
    public static partial class Create
    {
        ...
        public static ShapeCode77 ShapeCode77(double a, double b, double c, double diameter, double bendRadius)
        {
            ...
            ShapeCode77 shapeCode = new ShapeCode77(a, b, c, diameter, bendRadius);
