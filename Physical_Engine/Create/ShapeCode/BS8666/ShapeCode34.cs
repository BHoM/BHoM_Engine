...
namespace BH.Engine.Physical
{
    public static partial class Create
    {
        ...
        public static ShapeCode34 ShapeCode34(double a ,double c, double d, double e, double f, double diameter, double bendRadius)
        {
            ...
            ShapeCode34 shapeCode = new ShapeCode34(a, b, c, d, e, f, diameter, bendRadius);
