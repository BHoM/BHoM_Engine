...
namespace BH.Engine.Physical
{
    public static partial class Create
    {
        ...
        public static ShapeCode75 ShapeCode75(double a, double b, double diameter, double bendRadius)
        {
            ...
            ShapeCode75 shapeCode = new ShapeCode75(a, b, diameter, bendRadius);
