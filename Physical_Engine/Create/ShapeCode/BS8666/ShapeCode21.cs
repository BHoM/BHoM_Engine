...
namespace BH.Engine.Physical
{
    public static partial class Create
    {
        ...
        public static ShapeCode21 ShapeCode21(double a, double b, double c, double diameter, double bendRadius = 0)
        {
            ...
            ShapeCode21 shapeCode = new ShapeCode21(a, b, c, diameter, bendRadius);
