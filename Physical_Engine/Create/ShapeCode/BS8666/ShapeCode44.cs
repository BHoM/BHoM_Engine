...
namespace BH.Engine.Physical
{
    public static partial class Create
    {
        ...
        public static ShapeCode44 ShapeCode44(double a, double b ,double c, double d, double e, double diameter, double bendRadius)
        {
            ...
            ShapeCode44 shapeCode = new ShapeCode44(a, b, c, d, e, diameter, bendRadius);
