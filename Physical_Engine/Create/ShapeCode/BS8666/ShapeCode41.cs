...
namespace BH.Engine.Physical
{
    public static partial class Create
    {
        ...
        public static ShapeCode41 ShapeCode41(double a, double b ,double c, double d, double e, double diameter, double bendRadius)
        {
            ...
            ShapeCode41 shapeCode = new ShapeCode41(a, b, c, d, e, diameter, bendRadius);
