...
namespace BH.Engine.Physical
{
    public static partial class Create
    {
        ...
        public static ShapeCode98 ShapeCode98(double a, double b, double c, double d, double diameter, double bendRadius)
        {
            ...
            ShapeCode98 shapeCode = new ShapeCode98(a, b, c, d, diameter, bendRadius);
