...
namespace BH.Engine.Physical
{
    public static partial class Create
    {
        ...
        public static ShapeCode51 ShapeCode51(double a, double b, double c, double diameter, double bendRadius)
        {
            ...
            ShapeCode51 shapeCode = new ShapeCode51(a, b, c, c, diameter, bendRadius);
