...
namespace BH.Engine.Physical
{
    public static partial class Create
    {
        ...
        public static ShapeCode24 ShapeCode24(double a, double c, double d, double e, double diameter, double bendRadius = 0)
        {
            ...
            ShapeCode24 shapeCode = new ShapeCode24(a, b, c, d, e, diameter, bendRadius);
