...
namespace BH.Engine.Spatial
{
    public static partial class Query
    {
        ...
        public static List<ICurve> CurveLayout(this OffsetCurveLayout offsetCurveLayout, IEnumerable<ICurve> hostRegionCurves, IEnumerable<ICurve> openingCurves = null)
        {
            List<ICurve> curveLayout = new List<ICurve>();

            foreach (ICurve c in hostRegionCurves)
                curveLayout.Add(c.IOffset(- offsetCurveLayout.Offset));
        ...
        [Input("openingCurves", "Optional opening curves in the region. Unused for ExplicitLayout.")]
        [Output("curves", "The Curves stored in the ExplicitLayout object.")]
        public static List<ICurve> CurveLayout(this ExplicitCurveLayout explicitCurveLayout, IEnumerable<ICurve> hostRegionCurves, IEnumerable<ICurve> openingCurves = null)
        {
        ...
        public static List<ICurve> ICurveLayout(this ICurveLaout curveLayout, IEnumerable<ICurve> hostRegionCurves, IEnumerable<ICurve> openingCurves = null)
        {
            return CurveLayout(curveLayout as dynamic, hostRegionCurves, openingCurves);
        }
    }
}
