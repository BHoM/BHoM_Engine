...
namespace BH.Engine.Spatial
{
    public static partial class Query
    {
        ...
        [Input("hostRegionCurves", "The region curve of the objects associated with the layout. Unused for Explicit layouts.")]
        ...
        public static List<Point> PointLayout(this ExplicitLayout layout2D, IEnumerable<ICurve> hostRegionCurves, List<ICurve> openingCurves = null)
        {
        ...
        [Input("layout2D", "The layout object to query the points from.")]
        [Input("hostRegionCurves", "The region curve of the objects associated with the layout.")]
        ...
        public static List<Point> PointLayout(this PerimeterLayout layout2D, IEnumerable<ICurve> hostRegionCurves, List<ICurve> openingCurves = null)
        {
            List<ICurve> subCurves = hostRegionCurves.ISubParts().ToList();
            if (layout2D.EnforceDiscontinuityPoints && subCurves.Count != 1)
            {
                List<Point> pts = hostRegionCurves.IDiscontinuityPoints();
                pts.Add(hostRegionCurves.IStartPoint());
                pts.Add(hostRegionCurves.IEndPoint());
                ...
                pts = pts.ISortAlongCurve(hostRegionCurves);
                return pts;
            }
            else
            {
                int divisions = layout2D.NumberOfPoints;
                bool closed = hostRegionCurves.IIsClosed();

                if (!closed)
                    divisions--;

                List<Point> pts = hostRegionCurves.SamplePoints(divisions);
        ...
        [Output("points", "Point layout generated by the layout objects and region curve.")]
        public static List<Point> PointLayout(this LinearLayout layout2D, IEnumerable<ICurve> hostRegionCurves, List<ICurve> openingCurves = null)
        {
            Point refPoint = ReferencePoint(hostRegionCurves, openingCurves, layout2D.ReferencePoint);
            refPoint = refPoint + layout2D.Offset * AlignOffsetVector(Vector.ZAxis.CrossProduct(layout2D.Direction), refPoint, hostRegionCurves.IBounds().Centre());
        ...
        [Input("openingCurves", "Optional opening curves in the region.")]
        [Output("points", "Point layout generated by the layout objects and region curve.")]
        public static List<Point> PointLayout(this MultiLinearLayout layout2D, IEnumerable<ICurve> hostRegionCurves, List<ICurve> openingCurves = null)
        {
            Point refPoint = ReferencePoint(hostRegionCurves, openingCurves, layout2D.ReferencePoint);
            Vector offsetDir = AlignOffsetVector(Vector.ZAxis.CrossProduct(layout2D.Direction), refPoint, hostRegionCurves.Bounds().Centre());
        ...
        [Input("openingCurves", "Optional opening curves in the region.")]
        [Output("points", "Point layout generated by the layout objects and region curve.")]
        public static List<Point> IPointLayout(this ILayout2D layout2D, IEnumerable<ICurve> hostRegionCurves, List<ICurve> openingCurves = null)
        {
        ...
        private static List<Point> PointLayout(this ILayout2D layout2D, IEnumerable<ICurve> hostRegionCurves, List<ICurve> openingCurves = null)
        {
        ...
        private static Point ReferencePoint(IEnumerable<ICurve> hostRegionCurves, List<ICurve> openingCurves, ReferencePoint referencePoint)
        {
            if (referencePoint == oM.Spatial.Layouts.ReferencePoint.Centroid)
            {
                return CentroidWithOpeings(hostRegionCurves.ToList(), openingCurves);
            }
            BoundingBox bounds = Geometry.Query.Bounds(hostRegionCurves.Select(x => x.IBounds()).ToList());
        ...
        private static List<Line> IntersectionLines(this IEnumerable<ICurve> hostRegionCurves, List<ICurve> openingCurves, Line axis, double minimumEndDistance = -1, double tolerance = Tolerance.Distance)
        {
