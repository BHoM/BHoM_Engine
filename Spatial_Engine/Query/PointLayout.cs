...
namespace BH.Engine.Spatial
{
    public static partial class Query
    {
        ...
        [Description("Returns the points in the layout. Will not take the host geometry into acount for ExplicitLayout")]
        ...
        [Description("Returns a series of points along the host region curve, based on the parameters in the PerimiterLayout.")]
        [Input("layout2D", "The layout object to query the points from.")]
        [Input("hostRegionCurve", "The region curve of the objects associated with the layout.")]
        [Input("openingCurves", "Optional opening curves in the region. Unused for PerimiterLayouts.")]
        [Output("points", "Point layout generated by the layout objects and region curve.")]
        public static List<Point> PointLayout(this PerimiterLayout layout2D, ICurve hostRegionCurve, List<ICurve> openingCurves = null)
        {
