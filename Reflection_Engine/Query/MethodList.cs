...
namespace BH.Engine.Reflection
{
    public static partial class Query
    {
        ...
        private static void StoreAllMethods(Type type)
        {
            ...
            if (type.Name.Contains("FileAdapter"))
            {
                int gna = 0;
                //var gangn1 = type.GetMethods(bindingAll).ToList();
                //var gangn = type.GetMethods(bindingAll).Where(x => x.GetMethodBody() != null && !x.IsAutoGenerated()).ToList(); 
            }
