...
namespace BH.Engine.Verification
{
    public static partial class Create
    {
        ...
        [Description("Creates a property value condition with comparison requirement set to equality. If the property under given name is not found, other sources are also searched:" +
        ...
        public static ValueCondition IsEqualTo(string propertyName, object referenceValue, object tolerance = null)
        {
