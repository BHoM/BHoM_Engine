...
namespace BH.Engine.Verification
{
    public static partial class Create
    {
        ...
        [Description("Creates a property value condition with comparison requirement set to 'less than or equal to'. If the property under given name is not found, other sources are also searched:" +
        ...
        public static ValueCondition IsLessThanOrEqualTo(string propertyName, object referenceValue, object tolerance = null)
        {
            return new ValueCondition
            {
                ValueSource = new PropertyValueSource { PropertyName = propertyName },
                ReferenceValue = referenceValue,
                ComparisonType = ValueComparisonType.LessThanOrEqualTo,
                Tolerance = tolerance,
            };
        }
