...
namespace BH.Engine.Verification
{
    public static partial class Create
    {
        ...
        [Description("Creates a property value condition with comparison requirement set to 'greater than or equal to'. If the property under given name is not found, other sources are also searched:" +
        ...
        public static ValueCondition IsGreaterThanOrEqualTo(string propertyName, object referenceValue, object tolerance = null)
        {
            return new ValueCondition
            {
                ValueSource = new PropertyValueSource { PropertyName = propertyName },
                ReferenceValue = referenceValue,
                ComparisonType = ValueComparisonType.GreaterThanOrEqualTo,
                Tolerance = tolerance,
            };
        }
