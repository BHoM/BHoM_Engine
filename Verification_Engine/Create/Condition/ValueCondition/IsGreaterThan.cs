...
namespace BH.Engine.Verification
{
    public static partial class Create
    {
        ...
        [Description("Creates a property value condition with comparison requirement set to 'greater than'. If the property under given name is not found, other sources are also searched:" +
        ...
        public static ValueCondition IsGreaterThan(string propertyName, object referenceValue, object tolerance = null)
        {
