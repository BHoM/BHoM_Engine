...
namespace BH.Engine.Verification
{
    public static partial class Create
    {
        ...
        [Description("Creates a logical OR condition based on a pair of conditions.")]
        ...
        [Output("condition", nameof(LogicalOrCondition) + " created based on the provided inputs.")]
