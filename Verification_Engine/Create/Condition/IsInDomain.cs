...
namespace BH.Engine.Verification
{
    public static partial class Create
    {
        ...
        [Description("Creates a property value condition with numerical domain (range) containment requirement. If the property under given name is not found, other sources are also searched:" +
        ...
        [Input("min", "Lower edge of the domain to check the value against.")]
        [Input("max", "Upper edge of the domain to check the value against.")]
        [Input("tolerance", "Tolerance value to be applied in comparison.")]
        [Output("condition", nameof(IsInDomain) + " created based on the provided inputs.")]
        public static IsInDomain IsInDomain(string propertyName, double min, double max, double tolerance = 1e-6)
        {
