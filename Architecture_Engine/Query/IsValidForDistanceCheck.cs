...
namespace BH.Engine.Architecture
{
    public static partial class Query
    {
        ...
        public static bool IsValidForDistanceCheck(this Opening opening1, Opening opening2, double maxDistance = double.NaN, double distanceTolerance = Tolerance.Distance, double angleTolerance = Tolerance.Angle)
        {
            ...
            if (!double.IsNaN(maxDistance))
            {
                ...
                double c = centerPoint2.Distance(point1onPlane2);
