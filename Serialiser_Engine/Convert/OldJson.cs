...
namespace BH.Engine.Serialiser
{
    public static partial class Convert
    {
        ...
        public static string ToOldJson(this object obj)
        {
            if (obj == null)
                return "";
            ...
            return Convert.ToOldBson(obj).ToJson<BsonDocument>(jsonWriterSettings);
        }
        ...
        public static object FromOldJson(string json)
        {
            if (json == "")
            {
                return null;
            ...
            else if (json.StartsWith("{"))
            {
                ...
                {
                    return Convert.FromOldBson(document);
                }
                else
                {
        ...
        [Output("json", "String representing the object in json.")]
        public static string ToOldJsonArray(this IEnumerable<object> objs)
        {
        ...
        public static IEnumerable<object> FromOldJsonArray(this string jsonArray)
        {
