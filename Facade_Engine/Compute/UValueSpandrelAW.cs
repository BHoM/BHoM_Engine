...
namespace BH.Engine.Facade
{
    public static partial class Compute
    {
        ...
        [Description("Returns effective U-Value of spandrel opening calculated using the Area Weighting Method. Requires center of opening U-value, frame U-value and edge U-value as OpeningConstruction and FrameEdgeProperty fragments.")]
        ...
        public static OverallUValue UValueSpandrelAW(this Opening opening)
        {
            if (opening == null)
            {
            ...
            int h;
            int j;
            double we = 0.254; //10" edge zone, per NFRC 100
