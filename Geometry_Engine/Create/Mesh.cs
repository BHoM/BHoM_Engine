...
namespace BH.Engine.Geometry
{
    public static partial class Create
    {
        ...
        [Description("Creates a random Mesh based on a seed. If no seed is provided, a random one will be generated. If Box is provided, the resuling geometry will be contained within the box.")]
        ...
        [Input("minNbCPs", "Minimun number of vertices in the random Mesh.")]
        ...
        [Description("Creates a random Mesh using the provided Random class. If Box is provided, the resuling geometry will be contained within the box.")]
