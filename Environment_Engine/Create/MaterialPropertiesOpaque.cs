...
namespace BH.Engine.Environment
{
    ...
    {
        public static MaterialPropertiesOpaque OpaqueMaterialProperties(string description = "", double conductivity = 0.0, double specificHeat = 0.0, double density = 0.0, double vapourDiffusionFactor = 0.0, double solarReflectanceExternal = 0.0, double solarReflectanceInternal = 0.0, double lightReflectanceExternal = 0.0, double lightReflectanceInternal = 0.0, double emissivityExternal = 0.0, double emissivityInternal = 0.0)
        {
            return new MaterialPropertiesOpaque
            {
