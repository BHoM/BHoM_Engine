...
namespace BH.Engine.Environment
{
    public static partial class Query
    {
        ...
        {
            BH.oM.Diffing.Diff output = BH.Engine.Diffing.Compute.IDiffing(pastSpace, followingSpace, propertiesToConsider);

            var modified = output.ModifiedObjects;
            var unchanged = output.UnchangedObjects;

            return new Output<IEnumerable<object>, IEnumerable<object>>
            {
                Item1 = modified,
                Item2 = unchanged,
            };
