...
namespace BH.Engine.Environment
{
    public static partial class Query
    {
        ...
        [Description("BH.Engine.Environment.Query.Height => Returns the height of a BHoM Geometry Polyline based on the bounding box of the polyline")]
        [Input("polyline", "BHoM Geometry Polyline")]
        [Output("The height of the polyline based on the difference in z values for its bounding box")]
        public static double Height(this Polyline polyline)
        {
            BoundingBox bBox = polyline.IBounds();
