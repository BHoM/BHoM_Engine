...
namespace BH.Engine.Environment
{
    public static partial class Query
    {
        ...
        public static double MaximumLevel(this Panel panel, int decimals = 3)
        {
            if(panel == null)
            {
                BH.Engine.Base.Compute.RecordError("Cannot query the maximum level of a null panel.");
                return -1;
            }
        ...
        public static double MaximumLevel(this Opening opening, int decimals = 3)
        {
            if (opening == null)
            {
                BH.Engine.Base.Compute.RecordError("Cannot query the maximum level of a null opening.");
                return -1;
            }
