...
namespace BH.Engine.Environment
{
    public static partial class Query
    {
        ...
        public static double UValue(this Construction construction)
        {
            ...
            {
                IEnvironmentMaterial envMaterial = l.Material.Properties.Where(x => x.GetType() == typeof(IEnvironmentMaterial)).FirstOrDefault() as IEnvironmentMaterial;
                if (envMaterial == null) continue;
                rValue += (l.Thickness / envMaterial.Conductivity);
            }
