...
namespace BH.Engine.Environment
{
    public static partial class Compute
    {
        ...
        [Description("Adds a number to each element in an enumerable")]
        [Input("enumerable", "An enumerable")]
        [Input("number", "A number to add to each of the elements in the enumerable")]
        [Output("enumerable", "A modified enumerable")]
        public static List<double> Add(this List<double> enumerable, double number)
        {
        ...
        [Description("Perform an element-wise addition between two enumerables")]
        ...
        public static List<double> Add(this List<double> enumerable1, List<double> enumerable2)
        {
