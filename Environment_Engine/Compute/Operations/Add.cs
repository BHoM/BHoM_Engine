...
namespace BH.Engine.Environment
{
    public static partial class Compute
    {
        ...
        [Input("number", "A number to add to each of the elements in the IAnalysisResult.Result")]
        [Output("analysisResult", "A modified IAnalysisResult")]
        public static IAnalysisResult Add(this IAnalysisResult analysisResult, double number)
        {
        ...
        [Description("Add two IAnalysisResult objects together")]
        ...
        [Output("analysisResult", "A modified IAnalysisResult")]
        public static IAnalysisResult Add(this IAnalysisResult analysisResult1, IAnalysisResult analysisResult2)
        {
