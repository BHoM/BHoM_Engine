...
namespace BH.Engine.Environment
{
    public static partial class Compute
    {
        ...
        [Description("Divide each result value in an IAnalysisResult by a number")]
        ...
        public static IAnalysisResult Divide(this IAnalysisResult analysisResult, double number)
        {
        ...
        [Description("Perform an element-wise divide between two IAnalysisResult objects")]
        ...
        [Output("analysisResult", "A modified IAnalysisResult")]
        public static IAnalysisResult Divide(this IAnalysisResult analysisResult1, IAnalysisResult analysisResult2)
        {
