...
namespace BH.Engine.Environment
{
    public static partial class Compute
    {
        ...
        [Description("Divide each value in a list by a number")]
        [Input("enumerable", "An enumerable")]
        [Input("number", "A number by which to divide each of the elements in the enumerable")]
        [Output("enumerable", "A modified enumerable")]
        public static List<double> Divide(this List<double> enumerable, double number)
        {
        ...
        [Description("Perform an element-wise division between two enumerables")]
        ...
        public static List<double> Divide(this List<double> enumerable1, List<double> enumerable2)
        {
