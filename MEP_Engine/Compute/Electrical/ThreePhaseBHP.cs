...
namespace BH.Engine.MEP.Electrical
{
    public static partial class Compute
    {
        ...
        [Description("Calculates BHP (Brake Horsepower) for three phase equipment from volts, amps, power factor, and device efficiency")]
        [Input("voltage", " [V]")]
        [Input("amperage", " [A]")]
        [Input("powerFactor", "power factor")]
        [Input("deviceEfficiency", "device efficiency in decimal form (ex. 0.8)")]
        [Output("BHP", "[hp]")]
        public static double ThreePhaseBHP(double voltage, double amperage, double powerFactor, double deviceEfficiency)
        {
            ...
            double BHP = (Math.Sqrt(3) * voltage * amperage * powerFactor * deviceEfficiency)/746;
