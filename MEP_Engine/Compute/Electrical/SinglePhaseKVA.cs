...
namespace BH.Engine.MEP.Electrical
{
    public static partial class Compute
    {
        ...
        [Description("Calculates KVA for single phase equipment from volts and amps")]
        [Input("voltage", " [V]")]
        [Input("amperage", " [A]")]
        [Output("KVA", "[KVA]")]
        public static double SinglePhaseKVA(double voltage, double amperage)
        {
            ...
            double KVA = (voltage * amperage)/1000;
