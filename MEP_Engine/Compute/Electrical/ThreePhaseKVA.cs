...
namespace BH.Engine.MEP.Electrical
{
    public static partial class Compute
    {
        ...
        [Description("Calculates KVA for three phase equipment from volts and amps")]
        [Input("voltage", " [V]")]
        [Input("amperage", " [A]")]
        [Output("KVA", "[KVA]")]
        public static double ThreePhaseKVA(double voltage, double amperage)
        {
            ...
            double KVA = (Math.Sqrt(3) * voltage * amperage)/1000;
