...
namespace BH.Engine.MEP.Electrical
{
    public static partial class Compute
    {
        ...
        [Description("Calculates kilowatts for single phase equipment from volts, amps, and power factor.")]
        [Input("voltage", " [V]")]
        [Input("amperage", " [A]")]
        [Input("powerFactor", " power factor")]
        [Output("kilowatts", "[kW]")]
        public static double SinglePhaseKW(double voltage, double amperage, double powerFactor)
        {
            ...
            double kilowatts = (voltage * amperage * powerFactor)/1000;
