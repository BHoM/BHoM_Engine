...
namespace BH.Engine.MEP
{
    public static partial class Create
    {
        ...
        public static EnergyWheel EnergyWheel(double outdoorSummerEnteringDryBulbTemperature = 0.0, double outdoorSummerEnteringWetBulbTemperature = 0.0, double outdoorSummerLeavingDryBulbTemperature = 0.0, double outdoorSummerLeavingWetBulbTemperature = 0.0, double reliefSummerEnteringDryBulbTemperature = 0.0, double reliefSummerEnteringWetBulbTemperature = 0.0, double reliefSummerLeavingDryBulbTemperature = 0.0, double reliefSummerLeavingWetBulbTemperature = 0.0, double summerSensibleEffectiveness = 0.0, double summerTotalEffectiveness = 0.0, double outdoorWinterEnteringDryBulbTemperature = 0.0, double outdoorWinterEnteringWetBulbTemperature = 0.0, double outdoorWinterLeavingDryBulbTemperature = 0.0, double outdoorWinterLeavingWetBulbTemperature = 0.0, double reliefWinterEnteringDryBulbTemperature = 0.0, double reliefWinterEnteringWetBulbTemperature = 0.0, double reliefWinterLeavingDryBulbTemperature = 0.0, double reliefWinterLeavingWetBulbTemperature = 0.0, double winterSensibleEffectiveness = 0.0, double winterTotalEffectiveness = 0.0, string type = "", string control = "")
        {
