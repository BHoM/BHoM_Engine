...
namespace BH.Engine.MEP
{
    public static partial class Query
    {
        ...
        public static List<BHoMObject> GetFittingsConnectionObjects(List<Fitting> fittings, List<Duct> ducts, Duct firstDuct, Duct lastDuct)
        {
            ...
            /*            List<BHoMObject> ductRunInitial = new List<BHoMObject>();*/
            ...
            /*            foreach (Duct duct in ducts)
                        {
                            ...
                            {
                                if (fitting.ConnectionObjects.Contains(duct))
                                {
                                    break;
                                }
                                ductRunInitial.Add(duct);
                            }
                        }
                        foreach (Duct duct in ductRunInitial)
                        {
                    }
            */
