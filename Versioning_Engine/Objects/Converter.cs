...
namespace BH.Engine.Versioning.Objects
{
    public class Converter
    {
        ...
        public Dictionary<string, CustomVersioningMethod> ToNewObject { get; set; } = new Dictionary<string, CustomVersioningMethod>();

        public Dictionary<string, CustomVersioningMethod> ToOldObject { get; set; } = new Dictionary<string, CustomVersioningMethod>();
