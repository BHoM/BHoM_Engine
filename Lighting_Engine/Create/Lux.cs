...
namespace BH.Engine.Lighting
{
    public static partial class Create
    {
        ...
        [Output("luxResult", "The created Lux mesh element result.")]
        public static Lux Lux(List<double> lux, IComparable objectId, IComparable nodeId, IComparable meshFaceId, IComparable resultCase)
        {
