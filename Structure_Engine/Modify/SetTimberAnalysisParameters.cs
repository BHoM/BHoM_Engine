...
namespace BH.Engine.Structure
{
    public static partial class Modify
    {
        ...
        [Input("poissonsRatio_90_90", "Poisson's ratio for strain in the perpendicular direction generated by unit strain in the other perpendicular direction. Defaults to 0.4 though value varies depending on timber species.", typeof(Ratio))]
        [Output("timber", "The timber material with updated stiuffness properties based on the inputs and product specific values.")]
        public static void SetTimberAnalysisParameters(this ISurfaceProperty surfaceProperty, TimberAnalysisStiffness stiffnessType, TimberAnalysisOrientation orientationType = TimberAnalysisOrientation.Flatwise, TimberAnalysisDominantLoadCondition loadCondition = TimberAnalysisDominantLoadCondition.Bending, double poissonsRatio_0_90 = 0.4, double poissonsRatio_90_90 = 0.4)
        {
            _SetTimberAnalysisParameters(surfaceProperty as dynamic, stiffnessType, orientationType, loadCondition, poissonsRatio_0_90, poissonsRatio_90_90);
        }
        ...
        [Input("poissonsRatio_90_90", "Poisson's ratio for strain in the perpendicular direction generated by unit strain in the other perpendicular direction. Defaults to 0.4 though value varies depending on timber species.", typeof(Ratio))]
        [Output("timber", "The timber material with updated stiuffness properties based on the inputs and product specific values.")]
        private static void _SetTimberAnalysisParameters(this ISurfaceProperty surfaceProperty, TimberAnalysisStiffness stiffnessType, TimberAnalysisOrientation orientationType = TimberAnalysisOrientation.Unknown, TimberAnalysisDominantLoadCondition loadCondition = TimberAnalysisDominantLoadCondition.Bending, double poissonsRatio_0_90 = 0.4, double poissonsRatio_90_90 = 0.4)
        {
        ...
        [Input("poissonsRatio_90_90", "Poisson's ratio for strain in the perpendicular direction generated by unit strain in the other perpendicular direction. Defaults to 0.4 though value varies depending on timber species.", typeof(Ratio))]
        [Output("timber", "The timber material with updated stiuffness properties based on the inputs and product specific values.")]
        private static void _SetTimberAnalysisParameters(this Layered surfaceProperty, TimberAnalysisStiffness stiffnessType, TimberAnalysisOrientation orientationType = TimberAnalysisOrientation.Unknown, TimberAnalysisDominantLoadCondition loadCondition = TimberAnalysisDominantLoadCondition.Bending, double poissonsRatio_0_90 = 0.4, double poissonsRatio_90_90 = 0.4)
        {
        ...
        private static void SetTimberAnalysisParameters(this BHoMObject bhObj, TimberAnalysisStiffness stiffnessType, TimberAnalysisOrientation orientationType = TimberAnalysisOrientation.Unknown, TimberAnalysisDominantLoadCondition loadCondition = TimberAnalysisDominantLoadCondition.Bending, double poissonsRatio_0_90 = 0.4, double poissonsRatio_90_90 = 0.4)
        {
            if (bhObj is ITimber)
