...
namespace BH.Engine.Structure
{
    public static partial class Modify
    {
        ...
        [Description("Assigns a material fragemnt to a material. First removes any previous instances of the IStructuralMaterial from the list, then adds the new")]
        ...
        public static Material SetStructuralFragment(this Material material, IStructuralMaterial structuralFragment)
        {
            //Clone the object
            ...
            clone.Properties = clone.Properties.Where(x => !(x is IStructuralMaterial)).ToList();
