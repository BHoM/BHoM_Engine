...
namespace BH.Engine.Structure
{
    public static partial class Modify
    {
        ...
        [Input("loadCondition", "Controls if which primary load condition the element carrying the material will be exposed to.")]
        [Input("poissonsRatio_0_90", "Poisson's ratio for strain in the perpendicular direction generated by unit strain in the parallel direction. Defaults to 0.4, though value varies depending on timber species.", typeof(Ratio))]
        [Input("poissonsRatio_90_90", "Poisson's ratio for strain in the perpendicular direction generated by unit strain in the other perpendicular direction. Defaults to 0.4, though value varies depending on timber species.", typeof(Ratio))]
        [Output("timber", "The timber material with updated stiffness properties based on the inputs and product specific values.")]
        public static void SetAnalysisParameters(this LaminatedVeneerLumberCrossbands timber, TimberAnalysisStiffness stiffnessType, TimberAnalysisOrientation orientationType, TimberAnalysisDominantLoadCondition loadCondition, double poissonsRatio_0_90 = 0.4, double poissonsRatio_90_90 = 0.4)
        {
            ...
            if (orientationType == TimberAnalysisOrientation.Undefined)
            {
            ...
            if (loadCondition == TimberAnalysisDominantLoadCondition.Undefined)
            {
                Base.Compute.RecordError($"Requires set {nameof(TimberAnalysisDominantLoadCondition)} to be able to set analysis parameters for materials of type {nameof(LaminatedVeneerLumberCrossbands)}.");
                return;
            }
        ...
        private static void SetAnalysisParameters(this ITimber timber, TimberAnalysisStiffness stiffnessType, TimberAnalysisOrientation orientationType, TimberAnalysisDominantLoadCondition loadCondition, double poissonsRatio_0_90, double poissonsRatio_90_90)
        {
        ...
        private static void SetAnalysisParameters(this ITimber timber, TimberAnalysisStiffness stiffnessType, TimberAnalysisOrientation orientationType, double poissonsRatio_0_90, double poissonsRatio_90_90)
        {
