...
namespace BH.Engine.Structure
{
    public static partial class Create
    {
        ...
        public static Aluminium Aluminium(string name, double E = 70000000000, double v = 0.34, double tC = 0.000023, double density = 2710, double dampingRatio = 0, double embodiedCarbon = 6.57)
        {
        ...
        public static Concrete Concrete(string name, double E = 33000000000, double v = 0.2, double tC = 0.00001, double density = 2550, double dampingRatio = 0, double cubeStrength = 0, double cylinderStrength = 0, double embodiedCarbon = 0.242)
        {
            return new Concrete()
            {
                Name = name,
        ...
        [Description("Creates a steel material. First constructs a Steel material fragment, then applies it to a new Material class")]
        [Input("E", "Youngs modulus. Given in [Pa] or [N/m]. Will be stored on the material fragment")]
        [Input("v", "Poissons Ratio. Will be stored on the material fragment")]
        [Input("tC", "Modulus of thermal expansion. Given in [1/°C] or [1/K]. Will be stored on the material fragment")]
        [Input("density", "Given as [kg/m3]. Will be stored on the base material")]
        ...
        public static Steel Steel(string name, double E = 210000000000, double v = 0.3, double tC = 0.000012, double density = 7850, double dampingRatio = 0, double yieldStress = 0, double ultimateStress = 0, double embodiedCarbon = 0.938)
        {
            return new Steel()
            {
                Name = name,
        ...
        public static Timber Timber(string name, Vector E, Vector v, Vector G, Vector tC, double density, double dampingRatio, double embodiedCarbon = -1.15)
        {
            return new Timber()
            {
                Name = name,
