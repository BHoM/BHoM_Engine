...
namespace BH.Engine.Structure
{
    public static partial class Create
    {
        ...
        {
            //Method currently can not be removed due to being the target of a previous version upgrade from 3.3.
            //To be removed as soon as Versioning to create method via stepped upgrade is supported.
