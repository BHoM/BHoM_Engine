...
namespace BH.Engine.Structure
{
    public static partial class Create
    {
        ...
        public static BarUniformTemperatureLoad BarTemperatureLoad(Loadcase loadcase, double temperatureChange, BHoMGroup<Bar> group, LoadAxis axis = LoadAxis.Global, bool projected = false, string name = "")
        {
            return new BarUniformTemperatureLoad
            {
                Loadcase = loadcase,
