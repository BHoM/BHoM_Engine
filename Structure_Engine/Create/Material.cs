...
namespace BH.Engine.Structure
{
    public static partial class Create
    {
        ...
        public static Material AluminiumMaterial(string name, double E = 70000000000, double v = 0.34, double tC = 0.000023, double density = 2710, double dampingRatio = 0)
        {
            ...
            return Physical.Create.Material(name, density, new List<IMaterialProperties> { alumniniumFragment });
        }
        ...
        public static Material ConcreteMaterial(string name, double E = 33000000000, double v = 0.2, double tC = 0.00001, double density = 2550, double dampingRatio = 0, double cubeStrength = 0, double cylinderStrength = 0)
        {
            ...
            return Physical.Create.Material(name, density, new List<IMaterialProperties> { concreteFragment });
        }
        ...
        public static Material SteelMaterial(string name, double E = 210000000000, double v = 0.3, double tC = 0.000012, double density = 7850, double dampingRatio = 0, double yieldStress = 0, double ultimateStress = 0)
        {
            ...
            return Physical.Create.Material(name, density, new List<IMaterialProperties> { steelFragment });
        }
        ...
        public static Material TimberMaterial(string name, Vector E, Vector v, Vector G, Vector tC, double density, double dampingRatio)
        {
            ...
            return Physical.Create.Material(name, density, new List<IMaterialProperties> { timberFragment });
        }
