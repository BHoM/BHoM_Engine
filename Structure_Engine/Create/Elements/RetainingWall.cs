...
namespace BH.Engine.Structure
{
    public static partial class Create
    {
        ...
        public static RetainingWall RetainingWall(Stem stem, Footing footing, double retainedHeight = 0.0, double coverDepth = 0.0, double groundWaterDepth = 0.0, double retentionAngle = 0.0)
        {
            if (stem.IsNull())
                return null;
