...
namespace BH.Engine.Structure
{
    public static partial class Create
    {
        ...
        [Input("", "")]
        [Output("", "")]
        public static CellularSection CellularSectionFromBaseSection(ISectionProfile baseProfile, ICellularOpening opening)
        {
            ...
            TSectionProfile openingProfile = Spatial.Create.TSectionProfile(topHeight, baseProfile.Width, baseProfile.WebThickness, baseProfile.FlangeThickness, baseProfile.RootRadius, baseProfile.ToeRadius);
            ...
            edges = edges.Concat(edges.Select(x => x.IMirror(mirrorPlane))).ToList();
            Dictionary<string, double> constants = Compute.IntegrateSection(edges, Tolerance.MicroDistance);

            constants["J"] = baseProfile.ITorsionalConstant();
            constants["Iw"] = baseProfile.IWarpingConstant();

            ISectionProfile cutSection = new ISectionProfile(solidProfile.Height, solidProfile.Width, solidProfile.WebThickness, solidProfile.FlangeThickness, solidProfile.RootRadius, solidProfile.ToeRadius, edges);

            return new CellularSection(cutSection, solidProfile, opening, baseProfile, constants["Area"], constants["Rgy"], constants["Rgz"], constants["J"], constants["Iy"], constants["Iz"], constants["Iw"], constants["Wely"],
