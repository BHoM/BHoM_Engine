...
namespace BH.Engine.Structure
{
    public static partial class Query
    {
        ...
        {
            return node.IsNull("CoordinateSystem") ? null : Engine.Geometry.Create.CartesianCoordinateSystem(node.Position, node.Orientation.X, node.Orientation.Y);
        }
        ...
        {
            return mesh.IsNull("CoordinateSystem", false, false) ? null : mesh.Faces.Select(x => x.CoordinateSystem(mesh)).ToList();
        }
