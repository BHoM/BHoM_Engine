...
namespace BH.Engine.Structure
{
    public static partial class Query
    {
        ...
        public static List<ICurve> EdgeCurves(this RectangleSectionDimensions dimensions)
        {
        ...
        public static List<ICurve> EdgeCurves(this CircleDimensions dimensions)
        {
        ...
        public static List<ICurve> EdgeCurves(this TubeDimensions dimensions)
        {
        ...
        public static List<ICurve> EdgeCurves(this FabricatedBoxDimensions dimensions)
        {
        ...
        public static List<ICurve> EdgeCurves(this StandardBoxDimensions dimensions)
        {
            //TODO: Unequal plate thickness and welds
        ...
        public static List<ICurve> EdgeCurves(this FabricatedISectionDimensions dimensions)
        {
        ...
        public static List<ICurve> EdgeCurves(this StandardISectionDimensions dimensions)
        {
        ...
        public static List<ICurve> EdgeCurves(this PolygonDimensions dimensions)
        {
        ...
        public static List<ICurve> EdgeCurves(this StandardAngleSectionDimensions dimensions)
        {
        ...
        public static List<ICurve> EdgeCurves(this StandardChannelSectionDimensions dimensions)
        {
            //TODO: Implement
        ...
        public static List<ICurve> EdgeCurves(this StandardTeeSectionDimensions dimensions)
        {
        ...
        public static List<ICurve> EdgeCurves(this StandardZedSectionDimensions dimensions)
        {
            //TODO: Implement
            throw new NotImplementedException();
        }
        ...
        {
            return EdgeCurves(dimensions as dynamic);
        }
