...
namespace BH.Engine.Structure
{
    public static partial class Query
    {
        ...
        public static IBHoMGeometry GetReinforcementLayout(this ConcreteSection property, double xStart = 0, double xEnd = 1)
        {
            CompositeGeometry geometry = new CompositeGeometry();
            foreach (Reinforcement reo in property.Reinforcement)
            {
                IBHoMGeometry layout = reo.IGetLayout(property);
                if (typeof(CompositeGeometry).IsAssignableFrom(layout.GetType()))
                {
                    foreach (IBHoMGeometry obj in ((CompositeGeometry)layout).Elements)
                    {
                        if (obj is Point)
                        {
        ...
        public static IBHoMGeometry GetLayout(this LayerReinforcement reinforcement, ConcreteSection property, bool extrude = false)
        {
        ...
        public static IBHoMGeometry GetLayout(this PerimeterReinforcement reinforcement, ConcreteSection property, bool extrude = false)
        {
        ...
        public static IBHoMGeometry GetLayout(this TieReinforcement reinforcement, ConcreteSection property, bool extrude = false)
        {
            double tieDiameter = property.GetTieDiameter();
        ...
        public static IBHoMGeometry IGetLayout(this Reinforcement reinforcement, ConcreteSection property, bool extrude = false)
        {
