...
namespace BH.Engine.Structure
{
    public static partial class Query
    {
        ...
        [PreviousVersion("5.1", "BH.Engine.Structure.Query.DescriptionOrName(BH.oM.Structure.SurfaceProperties.ISurfaceProperty)")]
        [PreviousVersion("5.1", "BH.Engine.Structure.Query.DescriptionOrName(BH.oM.Structure.SectionProperties.ISectionProperty)")]
