...
namespace BH.oM.Geometry
{
    ...
    public class Transform
    {
        ...
        public Transform Scale(double value)
        {
            ...
            {
                m_Matrix[i] = ArrayUtils.Multiply(m_Matrix[i], value);
            }
            return this;
        }
        ...
        {
            return new Transform(ArrayUtils.Multiply(a, b));
        }
        ...
        {
            return new Vector(ArrayUtils.Multiply(a, b));
        }
        ...
        {
            return new Point(ArrayUtils.Multiply(a, b));
        }
    }
}