    ...
    public static class Intersect
    {
        ...
        public static bool PointCurve(Curve c, Point p, double tolerance, out double tParam)
        {
            ...
            for (int i = c.Degree + 1; i < c.Knots.Length; i++)
            {
                ...
                double distance = ArrayUtils.PointLineDistance(l1, l2, p);
        ...
        {
            return new Point(ArrayUtils.Intersect(line1.StartPoint, line1.Direction, line2.StartPoint, line2.Direction));
        }
        ...
        {
            double distance1 = ArrayUtils.LengthSq(ArrayUtils.Sub(pointComparison, pMin));
            double distance2 = ArrayUtils.LengthSq(ArrayUtils.Sub(pointComparison, pMax));
        ...
        //    if (ArrayUtils.Equal(p1, p2, 0.1)) return p1;

        //    double mid = (minT + maxT) / 2;

        //    double[] p3 = c.PointAt(mid);

        //    double distance1 = ArrayUtils.LengthSq(ArrayUtils.Sub(point, p1));
        //    double distance2 = ArrayUtils.LengthSq(ArrayUtils.Sub(point, p2));
        //    if (distance1 > distance2)
        //    {
