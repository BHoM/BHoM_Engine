...
namespace BH.Engine.Analytical
{
    public static partial class Create
    {
        ...
        [Output("graph", "Graph.")]
        [PreviousVersion("4.2", "BH.Engine.Analytical.Create.Graph(System.Collections.Generic.List<BH.oM.Base.IBHoMObject>, BH.oM.Base.ComparisonConfig)")]
        ...
        [Input("comparisonConfig", "Settings to determine the uniqueness of entities.")]
        [Output("graph", "Graph.")]
        [PreviousVersion("4.2", "BH.Engine.Analytical.Create.Graph(System.Collections.Generic.List<BH.oM.Analytical.Elements.IRelation>, BH.oM.Base.ComparisonConfig)")]
        ...
        [Input("comparisonConfig", "Settings to determine the uniqueness of entities.")]
        [Output("graph", "Graph.")]
        [PreviousVersion("4.2", "BH.Engine.Analytical.Create.Graph(System.Collections.Generic.List<BH.oM.Base.IBHoMObject>,System.Collections.Generic.List<BH.oM.Analytical.Elements.IRelation>, BH.oM.Base.ComparisonConfig)")]
        ...
        [Output("graph", "Graph.")]
        [PreviousVersion("4.2", "BH.Engine.Analytical.Create.Graph(System.Collections.Generic.List<BH.oM.Geometry.ICurve>,BH.oM.Base.IBHoMObject, System.Collections.Generic.List<BH.oM.Base.IBHoMObject>, System.Double, BH.oM.Analytical.Elements.RelationDirection)")]
        ...
        [Input("relationDirection", "Optional RelationDirection used to determine the direction that relations can be traversed. Defaults to Forward indicating traversal is from source to target.")]
        [Output("graph", "Graph.")]
        [PreviousVersion("4.2", "BH.Engine.Analytical.Create.Graph(System.Int32,System.Int32, BH.oM.Geometry.BoundingBox, BH.oM.Base.IBHoMObject, System.Double, BH.oM.Analytical.Elements.RelationDirection)")]
        ...
        [Input("relationDirection", "Optional RelationDirection used to determine the direction that relations can be traversed. Defaults to Forward indicating traversal is from source to target.")]
        [Output("graph", "Graph.")]
        [PreviousVersion("4.2", "BH.Engine.Analytical.Create.Graph(System.Int32,System.Int32, System.Int32, System.Double, BH.oM.Base.IBHoMObject, System.Double, BH.oM.Analytical.Elements.RelationDirection)")]
