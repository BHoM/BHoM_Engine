...
namespace BH.Engine.Analytical
{
    public static partial class Modify
    {
        ...
        [PreviousVersion("4.2", "BH.Engine.Analytical.Modify.IReverse(BH.oM.Analytical.Elements.IRelation)")]
        ...
        [PreviousVersion("4.2", "BH.Engine.Analytical.Modify.Reverse(BH.oM.Analytical.Elements.Relation)")]
        ...
        [PreviousVersion("4.2", "BH.Engine.Analytical.Modify.Reverse(BH.oM.Analytical.Elements.Graph)")]
