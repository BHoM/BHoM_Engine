...
namespace BH.Engine.Analytical
{
    public static partial class Modify
    {
        ...
        [PreviousVersion("4.3", "BH.Engine.Analytical.Modify.IProjectGraph(BH.oM.Analytical.Elements.Graph,BH.oM.Analytical.Elements.IProjection)")]
        ...
        [PreviousVersion("4.3", "BH.Engine.Analytical.Modify.IProjectGraph(BH.oM.Analytical.Elements.Graph,BH.oM.Analytical.Elements.GeometricProjection)")]
        ...
        [Input("projection", "The SpatialView.")]
        [Output("graph", "The spatial Graph.")]
        [PreviousVersion("4.3", "BH.Engine.Analytical.Modify.IProjectGraph(BH.oM.Analytical.Elements.Graph,BH.oM.Analytical.Elements.SpatialProjection)")]
        ...
        [PreviousVersion("4.3", "BH.Engine.Analytical.Modify.IProjectGraph(BH.oM.Analytical.Elements.Graph,BH.oM.Analytical.Elements.GraphicalProjection)")]
