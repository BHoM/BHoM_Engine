...
namespace BH.Engine.Analytical
{
    public static partial class Query
    {
        ...
        [PreviousVersion("4.2", "BH.Engine.Analytical.Query.IsolatedEntities(BH.oM.Analytical.Elements.Graph>")]
        public static List<Guid> IsolatedEntities<T>(this Graph<T> graph)
            where T : IBHoMObject
        {
            if(graph == null)
            {
