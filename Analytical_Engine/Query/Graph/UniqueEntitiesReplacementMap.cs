...
namespace BH.Engine.Analytical
{
    public static partial class Query
    {
        ...
        [PreviousVersion("4.2", "BH.Engine.Analytical.Query.UniqueEntitiesReplacementMap(System.Collections.Generic.List<BH.oM.Base.IBHoMObject>, BH.oM.Base.ComparisonConfig")]
