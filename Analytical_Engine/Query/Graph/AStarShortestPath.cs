...
namespace BH.Engine.Analytical
{
    public static partial class Query
    {
        ...
        [PreviousVersion("4.3", "BH.Engine.Analytical.Query.Adjacency(BH.oM.Analytical.Elements.Graph,BH.oM.Base.IBHoMObject,BH.oM.Base.IBHoMObject>")]
        ...
        [Output("shortest path result", "The ShortestPathResult.")]
        [PreviousVersion("4.3", "BH.Engine.Analytical.Query.Adjacency(BH.oM.Analytical.Elements.Graph,System.Guid,System.Guid>")]
