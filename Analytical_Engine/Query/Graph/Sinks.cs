...
namespace BH.Engine.Analytical
{
    public static partial class Query
    {
        ...
        [PreviousVersion("4.2", "BH.Engine.Analytical.Query.Sinks(BH.oM.Analytical.Elements.Graph>")]
        public static List<Guid> Sinks<T>(this Graph<T> graph)
            where T : IBHoMObject
        {
            if(graph == null)
            {
                BH.Engine.Reflection.Compute.RecordError("Cannot query the sinks of a null graph.");
