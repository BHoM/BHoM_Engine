...
namespace BHoM.Geometry
{
    public static class XLine
    {
        ...
        public static double DistanceTo(this Line line, Line other)
        {
            ...
            if (intersection != null && (intersection.DistanceTo(line.ClosestPoint(intersection)) < BHoM.Base.Tolerance.MIN_DIST) && (intersection.DistanceTo(other.ClosestPoint(intersection)) < BHoM.Base.Tolerance.MIN_DIST))
            {
                return 0;
            }
            else
