...
namespace BHoM.Structural.Properties
{
    public static class Create
    {
        ...
        {
            SteelSection section = new BHoM.Structural.Properties.SteelSection();
        ...
        public static SectionProperty NewCustomSection(MaterialType matType, BHoM.Geometry.Group<Curve> edges)
        {
        ...
        {
            BHoM.Geometry.Group<BHoM.Geometry.Curve> edges = null;
