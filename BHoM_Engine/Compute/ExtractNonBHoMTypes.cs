...
namespace BH.Engine.Base
{
    public static partial class Compute
    {
        ...
        {
            if (assembly == null || !Global.AllAssemblies.ContainsKey(assembly.GetName().Name) || assembly.ReflectionOnly)
            {
            ...
            {
                if (m_NonBHoMTypesReflected.Contains(assembly.GetName().Name) || assembly.IsBHoM())
                    return;

                m_NonBHoMTypesReflected.Add(assembly.GetName().Name);
