...
namespace BH.Engine.Base
{
    public static partial class Query
    {
        ...
        public static string Hash(this IObject iObj, IComparisonConfig comparisonConfig = null, bool hashFromFragment = false)
        {
            if (iObj == null)
            {
            ...
            IComparisonConfig cc = comparisonConfig == null ? new ComparisonConfig() : comparisonConfig.DeepClone();
        ...
        private static string DefiningString(object obj, IComparisonConfig cc, int fractionalDigits, int nestingLevel, string currentPropertyFullName = null)
        {
        ...
        private static void PopulateExceptionsFromPropertiesToConsider(IComparisonConfig cc, int nestingLevel, string currentPropertyFullName, Type currentObjType)
        {
