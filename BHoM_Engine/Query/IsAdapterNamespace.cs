...
namespace BH.Engine.Base
{
    public static partial class Query
    {
        ...
        [Description("Checks whether a given namespace is a valid BHoM Adapter namespace.")]
        [Input("ns", "Namespace to check whether it is a valid BHoM Adapter namespace.")]
